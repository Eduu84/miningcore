...
<img src="https://github.com/Eduu84/miningcore/raw/master/logo.png" width="150">
...
- Payment processing
- Banning System
- Live Stats [API](https://github.com/Eduu84/miningcore/wiki/API) on Port 4000
...
Code contributions are very welcome and should be submitted as standard [pull requests](https://docs.github.com/en/pull-requests) (PR) based on the [`dev` branch](https://github.com/Eduu84/miningcore/tree/dev).

## Building on Debian/Ubuntu

```console
git clone https://github.com/Eduu84/miningcore
cd miningcore
```
...
Refer to [this file](https://github.com/Eduu84/miningcore/blob/master/src/Miningcore/coins.json) for a complete list.
